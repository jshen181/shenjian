      ...
      if ( $menu_type === 'submenu' ) {
        ...
        if ( ! empty( $this->args['show_sub_menu'] ) && count( $this->pre_tabs ) > 1 ) {
          ...
          foreach ( $this->pre_tabs as $section ) {
            call_user_func( 'add_submenu_page', $menu_slug, esc_attr( $section['title'] ),  esc_attr( $section['title'] ), $menu_capability, $menu_slug .'#tab='. ( is_string( $section['title'] ) ? sanitize_title( $section['title'] ) : '' ), '__return_null' );
          }
        ...
        echo '<div class="zmop-wrapper'. esc_attr( $show_all ) .'">';
          ...
          if ( $has_nav ) {
            ...
            echo '<div class="zmop-nav zmop-nav-'. esc_attr( $nav_type ) .' zmop-nav-options">';
              ...
              foreach ( $this->pre_tabs as $tab ) {
                ...
                $tab_id    = is_string( $tab['title'] ) ? sanitize_title( $tab['title'] ) : '';
                ...
                if ( ! empty( $tab['subs'] ) ) {
                  ...
                  echo '<li class="zmop-tab-item">';
                    ...
                    foreach ( $tab['subs'] as $sub ) {
                      ...
                      $sub_id    = $tab_id .'/'. ( is_string( $sub['title'] ) ? sanitize_title( $sub['title'] ) : '' );
          ...
          echo '<div class="zmop-content">';
            ...
            foreach ( $this->pre_sections as $section ) {
              ...
              $section_parent = ( ! empty( $section['ptitle'] ) && is_string( $section['ptitle'] ) ) ? sanitize_title( $section['ptitle'] ) .'/' : '';
              $section_slug   = ( ! empty( $section['title'] ) && is_string( $section['title'] ) ) ? sanitize_title( $section['title'] ) : '';
