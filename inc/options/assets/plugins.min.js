...
jQuery(document).ready(function($) {
	...
	$(".zmop-expand-shut").click(function() {
		var tabItem = $('.zmop-tab-item');

		if (tabItem.hasClass('zmop-tab-expanded')) {
			tabItem.removeClass('zmop-tab-expanded');
		} else {
			tabItem.addClass('zmop-tab-expanded');
		}
	});
	...
	$('.selectall').on('change',
	function() {
		$(this).closest('ul').find('.item').prop('checked', this.checked);
	});

	$('.item').on('change',
	function() {
		var allChecked = true;
		$(this).closest('ul').find('.item').each(function() {
			if (!this.checked) {
				allChecked = false;
				return false;
			}
		});
		$(this).closest('ul').find('.selectAll').prop('checked', allChecked);
	});
});